...
public class BagIcon : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    public Image hint;//подсказка, что за иконка выбрана
    ...
    void ShowHint()//функция, показывающая подсказу
    {
        ...
        hint.GetComponentInChildren<Text>().text = "Сумка";//пишем, что это сумка
    }
